        ...
        <div class="row">
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">   
                    ...
                    <li class="page-item active"><a class="page-link" href="negyedik.php">4</a></li>
                </ul>
            </nav>
            <div class="h1 text-center">
                <label for="">Az oldal megnyitásainak száma: <?php echo $_SESSION["negyedik"]; ?></label>
            </div>
        </div>
    </div>
